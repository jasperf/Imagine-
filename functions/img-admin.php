		...
		class IMGCore {
			...
			function printAdminScripts () {
				if ( $_GET['page'] == basename(__FILE__) ) {
					wp_enqueue_style( 'img', get_bloginfo( 'template_directory').'/functions/stylesheets/admin.css');
					wp_enqueue_script( 'img', get_bloginfo( 'template_directory').'/functions/javascripts/admin.js', array( 'jquery' ));
			...
			function addAdminPage() {
				...
				add_theme_page($this->themename." Opties", $this->themename." Opties", 'edit_themes', basename(__FILE__), array(&$this, 'adminPage'));
			}
